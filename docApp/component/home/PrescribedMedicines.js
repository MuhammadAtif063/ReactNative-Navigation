...
import {Platform,StyleSheet,Text,View,Button,ListView} from 'react-native';
import ListViewStyles from '../../resources/css/list-view-styles';
//import UserService from '../services/user-service';
import PrescribedMedicineItemRow from './rows/prescribed-medicine-item';

const styles = ListViewStyles;
class PrescribedMedicines extends Component {
